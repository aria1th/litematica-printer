...
public class LitematicaMixinMod implements ModInitializer {
	...
	public static final ConfigBoolean PRINTER_SUPPRESS_PACKETS = new ConfigBoolean("printerSuppressPackets", false, "Printer will prevent other packets to server.");
	public static final ConfigBoolean PRINTER_FAKE_ROTATION_AGGRESSIVE = new ConfigBoolean("printerFakeRotationAggressive", false, "Printer will try to send fake rotation packets to server every tick.");
